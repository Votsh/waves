...
#ifndef ADAFRUIT_NEOPIXEL_VOTSH_H
#define ADAFRUIT_NEOPIXEL_VOTSH_H
...
class Adafruit_NeoPixel_Votsh {

 public:

  // Constructor: number of LEDs, pin number, LED type
  Adafruit_NeoPixel_Votsh(uint16_t n, uint8_t p=6, uint8_t t=NEO_GRB + NEO_KHZ800);
  ~Adafruit_NeoPixel_Votsh();
...
#endif // ADAFRUIT_NEOPIXEL_VOTSH_H
