...
// Exported operations.
     ...
     *
     * @exception DomainException (unchecked exception) Thrown if <TT>a</TT> is
     * 0; in other words, the coefficients do not represent a cubic equation.
     */
...
// Unit test main program.
    ...
    public static void main(String[] args)
        ...
        double a = 1;//Double.parseDouble(args[0]);
        double b = 3;//Double.parseDouble(args[1]);
        double c = -6;//Double.parseDouble(args[2]);
        double d = -8;//Double.parseDouble(args[3]);
        Cubic cubic = new Cubic();
        cubic.solve(a, b, c, d);
        System.out.println(cubic.nRoots);
    ...
    private static void usage() {
        System.err.println("Usage: java benchmarks.detinfer.pj.edu.rit.numeric.Cubic <a> <b> <c> <d>");
